/*! ngImgCrop v0.3.2 License: MIT */ ! function() {
    ...
    e.factory("cropAreaCircle", ["cropArea", function(e) {
        ...
        var t = function() {
            e.apply(this, arguments), this._resizeCtrlBaseRadius = 10, this._resizeCtrlNormalRatio = 1.2, this._resizeCtrlHoverRatio = 1, this._iconMoveNormalRatio = .9, this._iconMoveHoverRatio = 1.2, this._resizeCtrlNormalRadius = this._resizeCtrlBaseRadius * this._resizeCtrlNormalRatio, this._resizeCtrlHoverRadius = this._resizeCtrlBaseRadius * this._resizeCtrlHoverRatio, this._posDragStartX = 0, this._posDragStartY = 0, this._posResizeStartX = 0, this._posResizeStartY = 0, this._posResizeStartSize = 0, this._resizeCtrlIsHover = -1, this._areaIsHover = !1, this._resizeCtrlIsDragging = -1, this._areaIsDragging = !1
        };
        return t.prototype = new e, t.prototype._calcSquareCorners = function() {
         ...
         t.prototype.draw = function() {
            ...
            for (var t = this._calcSquareCorners(), i = 0, r = t.length; r > i; i++) {
                var s = t[i];
                if( i == 0){ 
                  this._cropCanvas.drawIconResizeBoxNWSE(s, this._resizeCtrlBaseRadius, this._resizeCtrlIsHover === i ? this._resizeCtrlHoverRatio : this._resizeCtrlNormalRatio)

                }else if( i == 1){
                  this._cropCanvas.drawIconResizeBoxNESW(s, this._resizeCtrlBaseRadius, this._resizeCtrlIsHover === i ? this._resizeCtrlHoverRatio : this._resizeCtrlNormalRatio)       
                }else if( i == 2){
                  this._cropCanvas.drawIconResizeBoxNESW(s, this._resizeCtrlBaseRadius, this._resizeCtrlIsHover === i ? this._resizeCtrlHoverRatio : this._resizeCtrlNormalRatio)
              }else if( i == 3){
                  this._cropCanvas.drawIconResizeBoxNWSE(s, this._resizeCtrlBaseRadius, this._resizeCtrlIsHover === i ? this._resizeCtrlHoverRatio : this._resizeCtrlNormalRatio)
        ...
        return t.prototype.getImage = function() {
            ...
            this._size > t && (this._size = t), this._size > e && (this._size = e), this._x < this._size / 6 && (this._x = this._size / 2), this._x > t - this._size / 2 && (this._x = t - this._size / 2), this._y < this._size / 2 && (this._y = this._size / 2), this._y > e - this._size / 2 && (this._y = e - this._size / 2)
        ...
        var e = [
            ...
            h = {
                areaOutline: "rgba(255,255,255, 0.1)",
                resizeBoxStroke: "#000",
                resizeBoxFill: "#fff",
                resizeBoxArrowFill: "#3B3E46",
        ...
        return function(c) {
                ...
                c.strokeStyle = h.resizeCircleStroke,
                 c.lineWidth = 0,
                  c.fillStyle = h.resizeCircleFill, 
                    ...
                    c.beginPath();  
                    c.arc(e[0] - r / 4, e[1] - r / 5, 10, 0, Math.PI*2, false);  
                    c.closePath();  
                    c.fill(); 
            }, 
                ...
                c.strokeStyle = h.resizeBoxStroke,
                 c.lineWidth = 0,
                  c.fillStyle = h.resizeBoxFill, 
                  	...
                  	c.beginPath();  
					c.arc(e[0] - r / 42, e[1] - r / 58, 15, 0, Math.PI*2, false);  
					c.closePath();  
					c.fill();  
            }, 
            
            this.drawIconResizeBoxBaseRotate = function(e, t, i){
                  var r = t * i;
                c.save(), 
                c.strokeStyle = h.resizeBoxStroke,
                 c.lineWidth = 0,
            ...
            this.drawCropArea = function(e, t, i, r) {
                var s = e.width / c.canvas.width,
                    ...
                    a = t[0] - i / 2,
                    n = t[1] - i / 2;
                c.save(), c.strokeStyle = h.areaOutline, c.lineWidth = 0, c.beginPath(), r(c, t, i), c.stroke(), c.clip(), i > 0 && c.drawImage(e, a * s, n * o, i * s, i * o, a, n, i, i), c.beginPath(), r(c, t, i), c.stroke(), c.clip(), c.restore()
            }
        }
        ...
        return function(o, a, n) {
            function h() {
                c.clearRect(0, 0, c.canvas.width, c.canvas.height), null !== l && (c.drawImage(l, 0, 0, c.canvas.width, c.canvas.height), c.save(), c.fillStyle = "rgba(0, 0, 0, 0.54)", c.fillRect(0, 0, c.canvas.width, c.canvas.height), c.restore(), u.draw())
            }
            var c = null,
                l = null,
                u = null,
